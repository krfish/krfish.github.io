...
Summary: Today, I finished Day 2 Part 1. I think this problem was the toughest one yet, due to it involving many of the components we have already learned so far such as deep copy and non-deep copy of lists. One thing I noticed while I was doing this problem, is that I first thought it would be easy, and dove right in, but I was however quickly frustrated and couldn't find out the coding answer. However, after taking a break coming back, and starting from a clean state, I found it easier to type out what I wanted my code to do. Once I finished typing out my code(essay style) it was much more easier to write the code out and it went more smooth. I also like how each challenge builds upon the other while being different at the same time. For example, it's similar to a present box inside of a present box, and to open each present box you have to solve a riddle. You eventually will get to the inside which is where your present lies. This is kind of similar, with coding problems replacing the riddles, and the present being the satisfaction of completing the problem. 
...
My next goal is to solve this problem first. I think I will spend five minutes tomorrow trying things out, and if it doesn't work, I will reach out to Lax for help on Slack. Then, I will continue to part 2 of the Day 1 problem, and I can hopefully complete all five problems in the time left. 
NextSteps:
My goal for tomorrow is to finish Day 2 part 2. I also learned that I can use pycharm to back up my code with Git Hub. I hope to learn how to do this tomorrow, so I can put it in this GitHub repository for everyone to view along with my blogs.   
